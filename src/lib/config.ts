...
// let baseUrl: string = (import.meta as any).env?.VITE_API_BASE_URL ?? 'https://farm-connetytct.amritagrotech.com/api';
// let baseUrl: string = (import.meta as any).env?.VITE_API_BASE_URL ?? 'http://127.0.0.1:8000';
// let baseUrl: string = (import.meta as any).env?.VITE_API_BASE_URL ?? 'http://192.168.1.6:8000';
